...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "choigay.png")) request("https://i.imgur.com/PLKSRpp.jpg").pipe(fs.createWriteStream(dirMaterial + "choigay.png"));
}
...
async function makeImage({ one, two }) {    
    ...
    let gay_image = await jimp.read(__root + "/choigay.png");
